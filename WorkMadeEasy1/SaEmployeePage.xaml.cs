...
{
	public partial class SaEmployeePage : ContentPage
	{
		...
		public SaEmployeePage()
		{
			InitializeComponent();
			manager = ScheduleManager.DefaultManager;
		}

		public SaEmployeePage(String emailid)
		{
			InitializeComponent();
...

		{
			...
			if (result == true)
			{
				...
				{
					emailMessenger.SendEmail("nhlin@scu.edu", "Call-Out Shift", "I am calling out the Shift " + shift.Text + " at " + workPlace.Text + " on " + workDay.Text + ". Sorry!");
				}
